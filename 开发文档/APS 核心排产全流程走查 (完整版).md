...
**00:30 - APS_BOM_RAW + APS_BOM_STAGE_PATH_RAW 拉取**（2026-04-18 更新）：
- **负责人**：2号位
- **Socket-Plug流程**：
...
- **动作**：使用SqlBulkCopy拉取350万行BOM数据 + 阶段路径明细
- **执行时间**：约5分钟
...
00:30 ODS.MES_APS_BOM_Workset → APS.APS_BOM_RAW + ODS.StageDetail → APS.APS_BOM_STAGE_PATH_RAW (SqlBulkCopy)
